...
import { IPoHeaderCondition, IPoJobCondition, IPoJobSetParams } from 'src/common/interfaces/database_domain.interface';
import { IQueryPoJobListResponse } from '../interfaces';
...
export class PoJobsService {
  constructor(
    ...
    async reservePoJobToProcess(condition: IPoJobCondition, setParams: IPoJobSetParams): Promise<PoJobs> {
    ...
    async queryPoJobList(conditionPoJob: IPoJobCondition, conditionPoHeader: IPoHeaderCondition): Promise<IQueryPoJobListResponse[]> {
